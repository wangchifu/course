...
class CreateYearsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('years', function (Blueprint $table) {
            ...
            $table->string('step3_date1')->nullable();//依初審修正1
            $table->string('step3_date2')->nullable();//依初審修正2
            $table->string('step4_date1')->nullable();//複審1
            $table->string('step4_date2')->nullable();//複審2
            $table->string('step5_date1')->nullable();//依複審修正1
            $table->string('step5_date2')->nullable();//依複審修正2
            $table->string('step6_date1')->nullable();//開放查詢1
            $table->string('step6_date2')->nullable();//開放查詢2
            $table->timestamps();
        });
    }
