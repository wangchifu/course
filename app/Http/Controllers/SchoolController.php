...
class SchoolController extends Controller
{
    ...
    public function show_first_suggest1($select_year)
    {
        $course = Course::where('year',$select_year)
            ->where('school_code',auth()->user()->code)
            ->first();
        ...
        return view('schools.first_suggest1',$data);
    }

    public function show_first_suggest2($select_year)
    {
        $course = Course::where('year',$select_year)
            ->where('school_code',auth()->user()->code)
            ->first();
        ...
        return view('schools.first_suggest2',$data);
    }
