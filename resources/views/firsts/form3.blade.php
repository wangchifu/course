@if(!is_null($course))
    @section('c1_1')
        @if($course->first_suggest2->c1_1_pass===0)
        <td width="200">
    ...
    @section('c1_2')
        @if($course->first_suggest2->c1_2_pass===0)
        <td>
    ...
    @section('c2')
        @if($course->first_suggest2->c2_pass===0)
        <td>
    ...
    @section('c3_1')
        @if($course->first_suggest2->c3_1_pass===0)
        <td>
    ...
    @section('c3_2')
        @if($course->first_suggest2->c3_2_pass===0)
        <td>
    ...
    @section('c3_3')
        @if($course->first_suggest2->c3_3_pass===0)
        <td>
    ...
    @section('c4')
        @if($course->first_suggest2->c4_pass===0)
        <td>
    ...
    @section('c6')
        @if($course->first_suggest2->c6_pass===0)
        <td>
    ...
    @section('c7_1')
        @if($course->first_suggest2->c7_1_pass===0)
        <td>
    ...
    @section('c7_2')
        @if($course->first_suggest2->c7_2_pass===0)
        <td>
    ...
    @section('c8_1')
        @if($course->first_suggest2->c8_1_pass===0)
        <td>
    ...
    @section('c8_2')
        @if($course->first_suggest2->c8_2_pass===0)
        <td>
    ...
    @section('c9')
        @if($course->first_suggest2->c9_pass===0)
        <td>
    ...
    @section('c10_1')
        @if($course->first_suggest2->c10_1_pass===0)
        <td>
    ...
    @section('c10_2')
        @if($course->first_suggest2->c10_2_pass===0)
        <td rowspan="5">
    ...
    @section('c11')
        @if($course->first_suggest2->c11_pass===0)
        <td>
    ...
    @section('c12')
        @if($course->first_suggest2->c12_pass===0)
        <td>
