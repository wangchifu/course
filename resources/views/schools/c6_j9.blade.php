    ...
    <tr>
        ...
        @foreach($year9 as $v)
            <td>
                ...
                @else
                    <a href="javascript:open_upload('{{ route('schools.c6_upload',['select_year'=>$year->year,'order'=>'c6','subject'=>'science_technology','grade'=>cht2num($v)]) }}','新視窗')" class="badge badge-danger check_red"><i class="fas fa-times-circle"></i> 未上傳</a>
                @endif
            </td>
        @endforeach
    </tr>
