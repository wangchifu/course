<div style="border:1px solid #96c2f1;background:#eff7ff;padding: 10px;">
    ...
    <table border="1">
        ...
        <tr>
            ...
            <td>
                @if($course->first_suggest1->c1_1_pass == 1)
        ...
        <tr>
            ...
            <td>
                @if($course->first_suggest1->c1_2_pass == 1)
                    <span class="text-success">符合</span>
                @else
                    <span class="text-danger">不符合</span>
                @endif
        ...
        <tr>
            ...
            <td>
                @if($course->first_suggest1->c2_pass == 1)
                    <span class="text-success">符合</span>
                @else
                    <span class="text-danger">不符合</span>
                @endif
        ...
        <tr>
            ...
            <td>
                @if($course->first_suggest1->c3_1_pass == 1)
                    <span class="text-success">符合</span>
                @else
                    <span class="text-danger">不符合</span>
                @endif
        ...
        <tr>
            ...
            <td>
                @if($course->first_suggest1->c3_2_pass == 1)
                    <span class="text-success">符合</span>
                @else
                    <span class="text-danger">不符合</span>
                @endif
        ...
        <tr>
            ...
            <td>
                @if($course->first_suggest1->c3_3_pass == 1)
                    <span class="text-success">符合</span>
                @else
                    <span class="text-danger">不符合</span>
                @endif
        ...
        <tr>
            ...
            <td>
                @if($course->first_suggest1->c4_pass == 1)
                    <span class="text-success">符合</span>
                @else
                    <span class="text-danger">不符合</span>
                @endif
        ...
        <tr>
            ...
            <td>
                @if($course->first_suggest1->c6_pass == 1)
                    <span class="text-success">符合</span>
                @else
                    <span class="text-danger">不符合</span>
                @endif
        ...
        <tr>
            ...
            <td>
                @if($course->first_suggest1->c8_1_pass == 1)
                    <span class="text-success">符合</span>
                @else
                    <span class="text-danger">不符合</span>
                @endif
        ...
        <tr>
            ...
            <td>
                @if($course->first_suggest1->c9_pass == 1)
                    <span class="text-success">符合</span>
                @else
                    <span class="text-danger">不符合</span>
                @endif
        ...
        <tr>
            ...
            <td>
                @if($course->first_suggest1->c10_1_pass == 1)
                    <span class="text-success">符合</span>
                @else
                    <span class="text-danger">不符合</span>
                @endif
        ...
        <tr>
            ...
            <td rowspan="2">
                @if($course->first_suggest1->c10_2_pass == 1)
                    <span class="text-success">符合</span>
                @else
                    <span class="text-danger">不符合</span>
                @endif
        ...
        <tr>
            ...
            <td>
                @if($course->first_suggest1->c11_pass == 1)
                    <span class="text-success">符合</span>
                @else
                    <span class="text-danger">不符合</span>
                @endif
        ...
        <tr>
            ...
            <td>
                @if($course->first_suggest1->c12_pass == 1)
                    <span class="text-success">符合</span>
                @else
                    <span class="text-danger">不符合</span>
                @endif
