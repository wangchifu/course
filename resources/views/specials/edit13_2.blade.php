...
<?php
    ...
    if($course->special_suggest13_2){
        $checked13_2_ok = ($course->special_suggest13_2->c13_2_pass)?"checked":null;
        $checked13_2_no = ($course->special_suggest13_2->c13_2_pass)?null:"checked";
    }else{
        $checked13_2_ok = "checked";
        $checked13_2_no = null;
    }
    $c13_2 = ($course->special_suggest13_2)?$course->special_suggest13_2->c13_2:null;
?>
...
@section('c13_2')
    <td>
        <input type="radio" name="c13_2_pass" id="c13_2_pass1" value="1" {{ $checked13_2_ok }}> <label for="c13_2_pass1">符合</label>　
        <input type="radio" name="c13_2_pass" id="c13_2_pass2" value="0" {{ $checked13_2_no }}> <label for="c13_2_pass2">不符合</label>
    </td>
    <td>
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    @if($course->special_suggest13_2)
                        {{ Form::open(['route'=>['specials.update13_2',$course->id],'method'=>'patch']) }}

                    @else
                        {{ Form::open(['route'=>'specials.store13_2','method'=>'post']) }}
                    @endif
