                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group">
                                        ...
                                        <input id="step5_date2" width="276" name="step5_date2" required maxlength="10" value="{{ old('step5_date2') }}">
                                        <script src="{{ asset('gijgo/js/messages/messages.zh-TW.js') }}"></script>
                                        <script>
                            ...
                            <tr>
                                <td>
                                    <div class="form-group">
                                        ...
                                        <input id="step6_date1" width="276" name="step6_date1" required maxlength="10" value="{{ old('step6_date1') }}">
                                        <script src="{{ asset('gijgo/js/messages/messages.zh-TW.js') }}"></script>
                                        <script>
                                ...
                                <td>
                                    <div class="form-group">
                                        ...
                                        <input id="step6_date2" width="276" name="step6_date2" required maxlength="10" value="{{ old('step6_date2') }}">
                                        <script src="{{ asset('gijgo/js/messages/messages.zh-TW.js') }}"></script>
                                        <script>
