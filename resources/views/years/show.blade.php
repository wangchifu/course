            ...
            <div class="col-md-9">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>階段2-1：依初審意見修正，再次上傳日期區間</label>
                            <strong class="text-primary">{{ $year->step5_date1 }}</strong>
                            至
                            <strong class="text-primary">{{ $year->step5_date2 }}</strong>
                        </div>
                        <div class="form-group">
                            <label>階段4：開放查詢日期區間</label>
                            <strong class="text-primary">{{ $year->step6_date1 }}</strong>
                            至
                            <strong class="text-primary">{{ $year->step6_date2 }}</strong>
                        </div>
